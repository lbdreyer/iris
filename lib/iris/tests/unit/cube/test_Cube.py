...
class Test_add_metadata(tests.IrisTest):
    ...
    def test_add_ancillary_dataset(self):
        ...
        cube.add_ancillary_dataset(ancillary_data)
...
class Test_remove_metadata(tests.IrisTest):
    def setUp(self):
        ...
        anciliary_dataset = AncillaryDataset(data=np.arange(6).reshape(2,3),
                                             long_name='detection quality')
        cube.add_ancillary_dataset(anciliary_dataset)
        self.cube = cube
    ...
    def test_remove_ancilliary_dataset(self):
        self.cube.remove_ancillary_dataset('detection_quality')
        self.assertEqual(self.cube._ancillary_datasets, [])
